...
public class EasyGsp2 {
        ...
        public void init(ServletContext servletContext, Object config) {
                try {
                        ...
                        AuthorizationValidator.init(propertiesFile);
                        loadDefaultRoutes();
        ...
        private void loadDefaultRoutes() {
                if (propertiesFile.getBoolean("jwt.controller.enabled", false)) {
                        ...
                        Routes.add("POST", "/client", JwtController.class, "addClient", new Class[]{String.class,HttpServletRequest.class}, new String[]{"admin"}, new String[]{MediaType.JSON}, new String[]{MediaType.JSON});
                }
        }
                                ...
                                for (String classPattern : classAnno.url()) {
                                        for (String _pattern : anno.url()) {
                                                ...
                                                for (String httpMethod : httpMethods) {
                                                        ...
                                                        String[] accepts = anno.accepts() != null ? classAnno.accepts() : anno.accepts();
                                                        String[] returns = anno.contentType() != null ? classAnno.contentType() : anno.contentType();
